...
<body>
	...
	<form:form id="inputForm" modelAttribute="szlHrLeave" action="${ctx}/leave/szlHrLeave/out" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="leaveType" htmlEscape="false" maxlength="255" class="input-xlarge required" readonly="true" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="leaveReason" htmlEscape="false" maxlength="255" class="input-xlarge required" readonly="true"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="leaveHours" htmlEscape="false" maxlength="255" class="input-xlarge required" readonly="true"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">备注：</label>
			<div class="controls">
				<form:textarea path="leaveRemark" htmlEscape="false" rows="4" maxlength="255" class="input-xxlarge " readonly="true"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="leave:szlHrLeave:check"><input id="btnSubmit" class="btn btn-primary" type="submit" value="驳 回"/>&nbsp;</shiro:hasPermission>
