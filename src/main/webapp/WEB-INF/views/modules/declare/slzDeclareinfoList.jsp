...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="declare:slzDeclareinfo:edit"><li><a href="${ctx}/declare/slzDeclareinfo/form">申报信息添加</a></li></shiro:hasPermission>
	</ul>
			...
			<tr>
				...
				<c:if  test="${slzDeclareinfo.declareStatus == '1'}" >
					<shiro:hasPermission name="declare:slzDeclareinfo:edit"><td>
    					<a href="${ctx}/declare/slzDeclareinfo/form?id=${slzDeclareinfo.id}">修改</a>
						<a href="${ctx}/declare/slzDeclareinfo/delete?id=${slzDeclareinfo.id}" onclick="return confirmx('确认要删除该申报信息吗？', this.href)">删除</a>
