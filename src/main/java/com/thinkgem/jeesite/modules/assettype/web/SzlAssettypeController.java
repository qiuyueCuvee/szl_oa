...
public class SzlAssettypeController extends BaseController {
	...
	public String save(SzlAssettype szlAssettype, Model model, RedirectAttributes redirectAttributes) {
		if (!beanValidator(model, szlAssettype)){
			return form(szlAssettype, model);
		}
		szlAssettypeService.save(szlAssettype);
		addMessage(redirectAttributes, "保存assettype成功");
